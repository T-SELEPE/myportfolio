...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_f5teb1c', 'template_ya3crac', form.current, 'KthCTmZ5Er_UDEUeE')
      .then(
        () => {
    ...
    <>
      <div className="container contact-page">
        ...
        <div className="info-map">
          ...
          <br />
          <span>tselepe97@gmail.com</span>
        </div>
        <div className="map-wrap">
        <MapContainer center={[-26.136562034622752, 28.241172722089516]} zoom={13}>
            <TileLayer url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" />
            <Marker position={[-26.136562034622752, 28.241172722089516]}>
              <Popup>Tshepo connects here! :)</Popup>
            </Marker>
          </MapContainer>
        </div>
      </div>
